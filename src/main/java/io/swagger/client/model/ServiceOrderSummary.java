 ...
 */
@Schema(description = "This structure is used to provide a subset of serviceOrder attributes to be provided in particular for notification messages")
...
public class ServiceOrderSummary {
  ...
  public ServiceOrderSummary id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ServiceOrderSummary href(String href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public ServiceOrderSummary externalId(String externalId) {
  ...
  **/
  ...
  public ServiceOrderSummary state(StateType state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public ServiceOrderSummary orderDate(OffsetDateTime orderDate) {
  ...
  **/
  ...
  public ServiceOrderSummary completionDateTime(OffsetDateTime completionDateTime) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ServiceOrderSummary serviceOrderSummary = (ServiceOrderSummary) o;
    return Objects.equals(this.id, serviceOrderSummary.id) &&
        Objects.equals(this.href, serviceOrderSummary.href) &&
        Objects.equals(this.externalId, serviceOrderSummary.externalId) &&
        Objects.equals(this.state, serviceOrderSummary.state) &&
        Objects.equals(this.orderDate, serviceOrderSummary.orderDate) &&
        Objects.equals(this.completionDateTime, serviceOrderSummary.completionDateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, href, externalId, state, orderDate, completionDateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceOrderSummary {\n");
